    ...
    chapters: [
        {
            ...
            lessons: [
                ...
                { id: "1.3", title: "1.3 ตัวอย่าง SRS งานระบบจัดการข้อมูลนักศึกษา", mainTitle: "ตัวอย่าง SRS ระบบจัดการข้อมูลนักศึกษา", subTitle: "(Project 1: Student Management SRS)", description: "วิเคราะห์และศึกษาโครงร่างเอกสาร SRS จริงสำหรับระบบทะเบียนและจัดการข้อมูลนักศึกษา", content: "<h3>อยู่ระหว่างการจัดเตรียมเนื้อหา</h3><p>เนื้อหาระบบจำลองการเรียนรู้ของหัวข้อนี้อยู่ระหว่างการเตรียมการจัดทำ</p>" },
