const dsaCourse = {
    ...
    chapters: [
        ...
        },
        {
            ...
            lessons: [
                { id: "2.1", title: "2.1 ความรู้เบื้องต้นเกี่ยวกับโครงสร้างข้อมูลแบบสแตก", mainTitle: "ความรู้เบื้องต้นเกี่ยวกับ Stack", subTitle: "(Introduction to Stack)", description: "สแตกคืออะไร และหลักการทำงานแบบเข้าหลังออกก่อน (LIFO)", content: "<h3>อยู่ระหว่างการจัดเตรียมเนื้อหา</h3><p>เนื้อหาหัวข้อนี้อยู่ระหว่างการจัดทำโครงสร้างระบบจำลอง</p>" },
