    ...
    chapters: [
        {
            ...
            lessons: [
                { id: "1.1", title: "1.1 นิยามและความแตกต่างของ UX และ UI", mainTitle: "นิยามและความแตกต่างของ UX และ UI", subTitle: "(Introduction to UX/UI)", description: "คำจำกัดความของ User Experience และ User Interface การสกัดส่วนแตกต่างและจุดประสานในการพัฒนาเทคโนโลยี", content: "<h3>อยู่ระหว่างการจัดเตรียมเนื้อหา</h3><p>เนื้อหาระบบจำลองการเรียนรู้ของหัวข้อนี้อยู่ระหว่างการเตรียมความพร้อมของแผนกออกแบบ</p>" },
