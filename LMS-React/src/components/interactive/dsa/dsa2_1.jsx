  ...
  return (
    <div className="font-sans text-slate-800 pb-24 relative">
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-12 pt-6 space-y-12 md:space-y-16 relative z-10">
        ...
        <TeacherTask
          title="ภารกิจท้ายบทเรียน: ปฏิบัติการจัดการ Stack ใน Python"
          pin="1122"
          taskText={`[โจทย์ปฏิบัติการหลักสูตรรายวิชาโครงสร้างข้อมูล 21900-1002]
โจทย์ปฏิบัติการจัดการ Stack ใน Python ให้นักเรียนเขียนคำสั่งต่อไปนี้:

1. สร้างสแตกว่างชื่อ stack = [] และใช้คำสั่งเพิ่ม "A" เข้าไป
2. กำหนดให้ stack = [10, 20] จงเขียนคำสั่งเพื่อ Push เลข 30 เข้าไปบนสุด
3. กำหนดให้ books = ["Math", "Science"] จงเขียนคำสั่งเพื่อดึงวิชาบนสุดออก (Pop)
4. กำหนดให้ undo_stack = ["Typing", "Deleting", "Formatting"] จงดึงข้อมูลบนสุดออกมาเก็บไว้ในตัวแปร last_action
5. กำหนดให้ cards = ["Ace", "King", "Queen"] จงเขียนคำสั่งเพื่อแสดงข้อมูลบนสุดของ Stack โดยไม่นำข้อมูลออก
6. กำหนดให้ browsers = ["Google", "Facebook"] จง Push "YouTube" เข้าไป แล้วหาจำนวนข้อมูลทั้งหมดใน Stack
7. กำหนดให้ history = ["Page1", "Page2", "Page3"] จงเขียนคำสั่งเพื่อตรวจสอบว่า Stack นี้มีความยาวเท่าใด
8. กำหนดให้ plates = ["Plate1", "Plate2"] จง Push "Plate3" เข้าไป แล้ว Pop ออกมา 1 ครั้ง
9. กำหนดให้ tasks = ["TaskA", "TaskB", "TaskC"] จงเขียนคำสั่งเพื่อ Pop ข้อมูลออก 2 ครั้ง
10. สร้างสแตกว่างชื่อ my_stack ทำการ Push ข้อมูล 5, 10, 15 ตามลำดับ แล้วดึงข้อมูลบนสุดออกมาแสดงผล`}
        />
