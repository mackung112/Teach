...
const testUrls = [
  ...
  'https://www.saladpuk.com/basic/uml/sequence-diagram/',
  'https://www.saladpuk.com/basic/ooad/sequence-diagram',
  'https://www.saladpuk.com/basic/ooad/sequence-diagram/',
  'https://www.saladpuk.com/basic/uml/sequence',
  'https://www.saladpuk.com/basic/uml/sequence/',
  'https://www.saladpuk.com/basic/design/sequence-diagram',
  'https://www.saladpuk.com/basic/design/sequence-diagram/',
  'https://www.saladpuk.com/basic/uml',
  'https://www.saladpuk.com/basic/uml/',
  'https://www.saladpuk.com/basic/ooad',
  'https://www.saladpuk.com/basic/ooad/'
];
  ...
  for (const url of testUrls) {
    try {
      ...
      if (result && result.isError) {
        ...
        console.log(`Preview: ${result.content[0].text.substring(0, 150)}...\n`);
      }
    } catch (e) {
